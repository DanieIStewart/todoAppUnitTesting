...
describe('controller', function () {
	...
	it('should highlight "All" filter by default', function () {
		...
		expect(view.render).toHaveBeenCalledWith('filter', {
			'All'
		});
	});
	...
	it('should highlight "Active" filter when switching to active view', function () {
		...
		expect(view.render).toHaveBeenCalledWith('showActive', {
		});
	});
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed', function () {
			// TODO: write test
			var todo = [ {id: 42, title: 'my todo',  completed: false, id: 8 },  {title: 'my todo', completed: false, id: 7} ];
		...
		it('should update the view', function () {
			// TODO: write test
			var todo = [ {id: 42, title: 'my todo',  completed: false, id: 8 }]

			// set up model 2 todos 
			setUpModel([todo]);

			subject.setView('');

			// view.trigger with new todo
			view.trigger('newTodo', 'my todo');
			
			// expect function update view port
			expect(view.render).toHaveBeenCalledWith('showAll', {
			});
		});
	});
	...
	describe('new todo', function () {
		it('should add a new todo to the model', function () {
			...
			subject.setView([todo]);

			// expect function update view port
			expect(view.render).toHaveBeenCalledWith('addItem', {
				todo
			});
		});
